...
def run():
    ...
    while True:
        ...
        # desenha o diagrama de campo de visao
        ...
        fov_text = font.render("campo de visao = %i" %int(fov), True, white)
        screen.blit(fov_text, (5, 35))
        txt = "distancia de visao = %.3f" %viewing_distance
